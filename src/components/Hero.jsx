...
export default function Hero() {
  ...
  const description =
    'At Daly Radiance Aesthetics, your well-being is at the heart of every treatment. Shelley combines medical expertise with a caring touch to help you feel confident, radiant, and truly yourself.'
  return (
